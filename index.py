...
html1+= '''
                <tr>
                    <td  class="time" colspan="2" style="text-align: center">8:00 - 9:00</td>
                    <td  class="time"  colspan="2" style="text-align: center">9:00 - 10:00</td>
                    <td  class="time" colspan="2" style="text-align: center">10:00 - 11:00</td>
                    <td  class="time" colspan="2" style="text-align: center">11:00 - 12:00</td>
                    <td  class="time" colspan="2" style="text-align: center">12:00 - 1:00</td>
                </tr>
                <tr>\n'''
for slot_no, slot in enumerate(even_day_morning):
    html1 += '<td class="slot" colspan="2">\n'
...
html2+= '''
                <tr>
                    <td class="time"  colspan="2" style="text-align: center">1:00 - 2:00</td>
                    <td class="time" colspan="2" style="text-align: center">2:00 - 3:00</td>
                    <td class="time" colspan="2" style="text-align: center">3:00 - 4:00</td>
                    <td class="time" colspan="2" style="text-align: center">4:00 - 5:00</td>
                    <td class="time" colspan="2" style="text-align: center">5:00 - 6:00</td>
                </tr>
                <tr>\n'''

for slot_no, slot in enumerate(even_day_evening):
    html2 += '<td class="slot" colspan="2">\n'
    for index, lt in enumerate(slot):
...
html1+= '''
                <tr>
                    ...
                    <td class="time"  colspan="3" style="text-align: center">9:30 - 11:00</td>
                    <td class="time" colspan="3" style="text-align: center">11:00 - 12:30</td>
                    <td class="time" style="text-align: center">12:30 - 1:00</td>
                </tr>
                <tr>'''
for slot_no, slot in enumerate(odd_day_morning):
    html1 += '<td class="slot" colspan="3">\n'
    for index, lt in enumerate(slot):
        html1 += '\tL'+str(index+1)+': '+str(lt)+'<br>\n'
